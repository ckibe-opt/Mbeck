...
class _ExpenseScreenState extends State<ExpenseScreen> {
  ...
  Future<void> _saveExpense() async {
    ...
    try {
      ...
      if (finalDetails.isEmpty) finalDetails = 'Expense Transaction';
              ...
              child: Padding(
                ...
                child: Row(
                  children: [
                    ...
                    const Text('Record Expense', style: TextStyle(fontSize: 22, fontWeight: FontWeight.w900, color: Color(0xFF111827), letterSpacing: -0.5)),
                  ],
                ),
              ),
            ),
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        Text(amountPreview, style: const TextStyle(fontSize: 36, fontWeight: FontWeight.w900, color: Color(0xFFEF4444), height: 1)),
                      ],
                    ),
                  ),
                  ...
                  Container(
                    ...
                    child: TextFormField(
                      ...
                      decoration: InputDecoration(
                        ...
                        prefixText: 'KES ',
                        prefixStyle: const TextStyle(fontSize: 14, fontWeight: FontWeight.w700, color: Color(0xFFEF4444)),
            ...
            child: Padding(
              ...
              child: GestureDetector(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    color: _isSaving ? const Color(0xFF9CA3AF) : const Color(0xFFEF4444),
                    borderRadius: BorderRadius.circular(14),
                    boxShadow: _isSaving ? null : [BoxShadow(color: const Color(0xFFEF4444).withOpacity(0.3), blurRadius: 8, offset: const Offset(0, 3))],
                  ),
                  child: Row(
                    ...
                    children: [
                      ...
                      Text(_isSaving ? 'SAVING...' : 'SAVE EXPENSE', style: const TextStyle(fontSize: 14, fontWeight: FontWeight.w900, color: Colors.white, letterSpacing: 0.5)),
                    ],
                  ),
                ),
              ),
